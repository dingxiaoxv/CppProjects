...
public:
  ...
  GenericRegex(const Ch *source, Allocator *allocator = 0)
      : states_(allocator, 256), ranges_(allocator, 256),
        root_(kRegexInvalidState), stateCount_(), rangeCount_(), stateSet_(),
        state0_(allocator, 0), state1_(allocator, 0), anchorBegin_(),
        anchorEnd_() {
