...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    // 创建并注册广播
    Advertisement adv(*connection, "/com/example/ble/advertisement");
    adv.setLocalName("BLE Heart Rate");
    adv.addServiceUUID("0000180d-0000-1000-8000-00805f9b34fb"); // Heart Rate
    adv.addServiceUUID("12345678-1234-5678-1234-56789abcdef0"); // Custom
    adv.registerToBlueZ(adapterPath);
